...
CREATE TABLE IF NOT EXISTS test.material_category
(
...
CREATE TABLE IF NOT EXISTS test.material_product
(
...
CREATE TABLE IF NOT EXISTS test.order_material
(
...
CREATE TABLE IF NOT EXISTS test.unit
(
...
CREATE TABLE IF NOT EXISTS test.user_order_change
(
...
ALTER TABLE IF EXISTS test.material_product
    ADD CONSTRAINT material_product_material_category_id_fkey FOREIGN KEY (material_category_id)
    REFERENCES test.material_category (material_category_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS test.material_product
    ...
    REFERENCES test.unit (unit_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;


ALTER TABLE IF EXISTS test.order_material
    ADD CONSTRAINT order_material_material_product_id_fkey FOREIGN KEY (material_product_id)
    REFERENCES test.material_product (material_product_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS test.order_material
    ...
    REFERENCES test.user_order (user_order_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;


ALTER TABLE IF EXISTS test.user_order
    ADD CONSTRAINT user_order_roof_type_id_fkey FOREIGN KEY (roof_type_id)
    REFERENCES test.roof_type (roof_type_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS test.user_order
    ...
    REFERENCES test.shed (shed_id) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS test.user_order
    ...
    REFERENCES test."user" (user_email) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;


ALTER TABLE IF EXISTS test.user_order_change
    ADD CONSTRAINT user_order_change_admin FOREIGN KEY (admin_email)
    REFERENCES test.admin (admin_email) MATCH SIMPLE
    ON UPDATE NO ACTION
       ON DELETE NO ACTION;
